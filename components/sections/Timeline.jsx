    ...
    <section className="py-20 px-6 md:px-12 lg:px-24 bg-[#f5f1ed]">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-12 gap-8">
          {/* LEFT SIDE - Timeline Line and Years */}
          <div className="col-span-12 md:col-span-4 relative">
            {/* Vertical Timeline Line */}
            <div className="hidden md:block absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-400 via-amber-400 to-yellow-400"></div>
